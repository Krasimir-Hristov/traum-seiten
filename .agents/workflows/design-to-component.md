...
1. Fetch the design utilizing Stitch MCP or analyze the provided design.
...
6. Verify that the component adheres to Accessibility (A11y) standards, adding `aria-label` to every interactive element, and is mobile-responsive.
